...
tf.app.flags.DEFINE_string('data_dir', '/tmp/kanji_data',
                           """Path to the KANJI data directory.""")
tf.app.flags.DEFINE_boolean('use_fp16', False,
                            """Train the model using fp16.""")

# Global constants describing the KANJI data set.
IMAGE_SIZE = kanji_input.IMAGE_SIZE
NUM_CLASSES = kanji_input.NUM_CLASSES
NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = kanji_input.NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN
...
def single_input(eval_data):
  """Construct input for evaluation of single image
...
def _add_loss_summaries(total_loss):
  """Add summaries for losses in KANJI model.
